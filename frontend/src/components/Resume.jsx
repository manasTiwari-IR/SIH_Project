...
const Resume = () => {
  ...
  const [ratingResult, setRatingResult] = useState('Upload a resume to check its rating.');
...
const handleCheckResume = () => {
  if (file) {
    if (file.size > 500 * 1024) { // Check file size (500KB)
  ...
  <div className="background">
    <div className="header">
      <div className="header-content">
        <h1 className={`dynamic-text ${ratingResult === 'Please upload a resume.' ? 'fade-out' : 'fade-in'}`}>
        {dynamicText}
      </h1>
  </div>
      </div >
    ...
    <div className="left-section">
      <div className="card-wrapper">
        ...
        <div className="card do-dont-card">
          ...
          <div className="content">
            ...
            <ul>
              ...
              <li>Include irrelevant personal information like age or marital status.</li>
              <li>Make your resume longer than two pages.</li>
              <li>Use inconsistent formatting or fonts.</li>
              <li>Forget to proofread for grammatical and typographical errors.</li>
              <li>Overuse buzzwords without demonstrating their relevance.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="card">
          <h2>Instructions</h2>
          <div className="content">
            <p>Follow these instructions to create the best possible resume:</p>
            <ol>
              ...
              <li>Tailor your resume for the specific job you are applying for.</li>
            </ol>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="example-grid">
            <div className="example-card">
              <img src="https://d.novoresume.com/images/landing_page/templates/template1.png" alt="Resume Example 1" />
            </div>
            <div className="example-card">
              <img src="https://d.novoresume.com/images/landing_page/templates/template2.png" alt="Resume Example 2" />
            </div>
            <div className="example-card">
              <img src="https://d.novoresume.com/images/landing_page/templates/template0.png" alt="Resume Example 3" />
            </div>
            <div className="example-card">
              <img src="https://d.novoresume.com/images/doc/modern-resume-template.png" alt="Resume Example 4" />
            </div>
          </div>
        </div>
        ...
        <div className="card ai-card">
          ...
          <div className="content">
            <p>Enhance your resume with AI-powered tools for better results:</p>
            <ul>
